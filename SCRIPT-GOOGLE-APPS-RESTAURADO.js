...
// Gerar PDF estático (cópia permanente) - FUNCIONALIDADE RESTAURADA
function gerarPDFEstatico() {
  try {
    ...
    // 2. Aguardar um momento para garantir que a cópia foi criada
    Utilities.sleep(2000);
    
    // 3. Gerar PDF da cópia
    ...
    console.log('📄 PDF estático gerado:', pdfUrl);
    
    // 4. Opcional: Mover a cópia para uma pasta específica no Drive
    try {
